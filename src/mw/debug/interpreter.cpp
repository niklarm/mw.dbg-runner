...
std::vector<std::string> interpreter::communicate(const std::string & in, char delim)
{
...
std::vector<std::string> interpreter::communicate(const std::string & in, const std::string & delim)
{
    asio::async_write(_in, asio::buffer(_in_buf), _yield);
    asio::async_read_until(_out, _out_buf, delim, _yield);
...
std::vector<std::string> interpreter::communicate(const std::string & in, const boost::regex & expr)
{
    asio::async_write(_in, asio::buffer(_in_buf), _yield);
