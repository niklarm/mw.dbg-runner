...
//[test_equal_def
struct test_equal : mw::gdb::break_point
{
    test_equal() : mw::gdb::break_point("test_equal(bool, const char *, const char *, const char*, int)")
    {
    }
...
//[test_equal_invoke_1
void test_equal::invoke(mw::gdb::frame & fr, const std::string & file, int line)
{
